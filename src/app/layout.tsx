      ...
      <body className={inter.className}>
        <div className="layout-container">
          ...
          pathname === "/imagepuzzle"||pathname === "/puzzleArena"|| pathname === "/learnclass"||pathname=="/puzzles"||pathname=="/levels/level1"||pathname=="/levels/level2"
            ...
            ||pathname=="/levels/level4test"||pathname=="/tornuments"||pathname=="/tournamentRegistration"||pathname=="/insidepuzzlearena") && <Sidebar />}
           <div className="content-container">
            {pathname !== "/" && pathname !== "/signin"&&pathname !== "/signup"&& pathname !== "/admin" && pathname !== "/admin_image_puzzles" && pathname !== "/admin_tournaments" && pathname !== "/StudentDetails" && pathname !== "/homeTornament"&& pathname !== "/homeTornRegister"  && <PortalHeader />}
